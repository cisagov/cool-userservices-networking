...
issue](https://github.com/cisagov/cool-userservices-networking/issues) in this
...
request](https://github.com/cisagov/cool-userservices-networking/pulls), you
...
```console
cd cool-userservices-networking
pyenv virtualenv <python_version_to_use> cool-userservices-networking
pyenv local cool-userservices-networking
